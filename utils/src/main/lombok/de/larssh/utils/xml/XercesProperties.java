...
public class XercesProperties {
	...
	public static class General {
		 ...
		 */
		public static final XmlProperty<String> XML_STRING
				= new XmlProperty<>("http://xml.org/sax/properties/xml-string");
		 ...
		 */
		public static final WritableXmlProperty<String> SCHEMA_EXTERNAL_SCHEMA_LOCATION
				= new WritableXmlProperty<>("http://apache.org/xml/properties/schema/external-schemaLocation");
		 ...
		 */
		public static final WritableXmlProperty<String> SCHEMA_EXTERNAL_NO_NAMESPACE_SCHEMA_LOCATION
				= new WritableXmlProperty<>(
		 ...
		 */
		public static final WritableXmlProperty<Object> VALIDATION_SCHEMA_ROOT_ELEMENT_DECLARATION
				= new WritableXmlProperty<>(
		 ...
		 */
		public static final WritableXmlProperty<Object> VALIDATION_SCHEMA_ROOT_TYPE_DEFINITION
				= new WritableXmlProperty<>("http://apache.org/xml/properties/validation/schema/root-type-definition");
		 ...
		 */
		public static final WritableXmlProperty<Integer> INPUT_BUFFER_SIZE
				= new WritableXmlProperty<>("http://apache.org/xml/properties/input-buffer-size");
		 ...
		 * @since Xerces-J 2.10.0
		 */
		public static final WritableXmlProperty<Locale> LOCALE
				= new WritableXmlProperty<>("http://apache.org/xml/properties/locale");
		 ...
		 */
		public static final WritableXmlProperty<Object> SECURITY_MANAGER
				= new WritableXmlProperty<>("http://apache.org/xml/properties/security-manager");
	}
	...
	public static class DOM {
		 ...
		 * an error occurs.
		 */
		public static final XmlProperty<Element> CURRENT_ELEMENT_NODE
				= new XmlProperty<>("http://apache.org/xml/properties/dom/current-element-node");
		 ...
		 * work.
		 */
		public static final WritableXmlProperty<String> DOCUMENT_CLASS_NAME
				= new WritableXmlProperty<>("http://apache.org/xml/properties/dom/document-class-name");
	}
	...
	public static class SAX {
		 ...
		 */
		public static final WritableXmlProperty<DeclHandler> DECLARATION_HANDLER
				= new WritableXmlProperty<>("http://xml.org/sax/properties/declaration-handler");

		/**
		 * Set the handler for lexical parsing events.
		 */
		public static final WritableXmlProperty<LexicalHandler> LEXICAL_HANDLER
				= new WritableXmlProperty<>("http://xml.org/sax/properties/lexical-handler");
		 ...
		 */
		public static final WritableXmlProperty<Node> DOM_NODE
				= new WritableXmlProperty<>("http://xml.org/sax/properties/dom-node");
		 ...
		 */
		public static final XmlProperty<String> DOCUMENT_XML_VERSION
				= new XmlProperty<>("http://xml.org/sax/properties/document-xml-version");
	}
}
